...
parser.add_argument('--synapses', type=int, default=0, help='Use synaptic model (GPTSynaptic) if 1 (note: model loaded from checkpoint will auto-detect)')
...
async def logo():
    ...
    logo_path = os.path.join('bio_inspired_nanochat', "logo.svg")
