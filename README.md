...
- **70** `SynapticConfig` hyperparameters, every one read by runtime code (the 6 dead fields were pruned in `8j9.5`). The "48-parameter genome" figure was an early planning estimate, not a code count.
