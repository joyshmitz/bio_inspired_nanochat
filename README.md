...
- **76** `SynapticConfig` hyperparameters today (**70 live**, 6 dead and slated for pruning). The "48-parameter genome" figure was an early planning estimate, not a code count.
